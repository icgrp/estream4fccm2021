...
#
# u96_prj_gen.tcl: Tcl script for re-creating project 'u96_demo'
#
# Generated by Vivado on Mon Apr 19 21:09:37 EDT 2021
...
#
# 1. This project restoration tcl script (u96_prj_gen.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/ylxiao/ws_183/estream4fccm2021/workspace/vivado_prj/u96_demo/u96_demo.srcs/sources_1/imports/vivado_prj/my_design.v"
#    "/home/ylxiao/ws_183/estream4fccm2021/workspace/vivado_prj/u96_demo/u96_demo.srcs/sources_1/imports/vivado_prj/design_1_wrapper.v"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/ylxiao/ws_183/estream4fccm2021/workspace/vivado_prj/axilitectrl.v"
#    "/home/ylxiao/ws_183/estream4fccm2021/workspace/vivado_prj/handshake_cnt.v"
#
#*****************************************************************************************
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/axilitectrl.v"] \
 [file normalize "${origin_dir}/handshake_cnt.v"] \
]
add_files -norecurse -fileset $obj $files

# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/u96_demo/u96_demo.srcs/sources_1/imports/vivado_prj/my_design.v"]\
 [file normalize "${origin_dir}/u96_demo/u96_demo.srcs/sources_1/imports/vivado_prj/design_1_wrapper.v"]\
]
...
if { [get_files axilitectrl.v] == "" } {
  import_files -quiet -fileset sources_1 /home/ylxiao/ws_183/estream4fccm2021/workspace/vivado_prj/axilitectrl.v
}
if { [get_files handshake_cnt.v] == "" } {
  import_files -quiet -fileset sources_1 /home/ylxiao/ws_183/estream4fccm2021/workspace/vivado_prj/handshake_cnt.v
}
if { [get_files handshake_cnt.v] == "" } {
  import_files -quiet -fileset sources_1 /home/ylxiao/ws_183/estream4fccm2021/workspace/vivado_prj/handshake_cnt.v
}
...
if { [get_files my_design.v] == "" } {
  import_files -quiet -fileset sources_1 /home/ylxiao/ws_183/estream4fccm2021/workspace/vivado_prj/u96_demo/u96_demo.srcs/sources_1/imports/vivado_prj/my_design.v
}
...
# module references:
# axilitectrl_v1_0, handshake_cnt, handshake_cnt, handshake_cnt, handshake_cnt, my_design
  ...
  # Create instance: axilitectrl_v1_0_0, and set properties
  set block_name axilitectrl_v1_0
  set block_cell_name axilitectrl_v1_0_0
  if { [catch {set axilitectrl_v1_0_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axilitectrl_v1_0_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: circ_buff_read_many1_0, and set properties
  set circ_buff_read_many1_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:circ_buff_read_many128:1.0 circ_buff_read_many1_0 ]
  set_property -dict [ list \
   CONFIG.C_M_AXI_GMEM_READ_CACHE_VALUE {"1111"} \
 ] $circ_buff_read_many1_0

  # Create instance: circ_buff_write_many_0, and set properties
  set circ_buff_write_many_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:circ_buff_write_many128:1.0 circ_buff_write_many_0 ]
  set_property -dict [ list \
   CONFIG.C_M_AXI_GMEM_OUT_CACHE_VALUE {"1111"} \
 ] $circ_buff_write_many_0

  # Create instance: handshake_cnt_0, and set properties
  set block_name handshake_cnt
  set block_cell_name handshake_cnt_0
  if { [catch {set handshake_cnt_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $handshake_cnt_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: handshake_cnt_1, and set properties
  set block_name handshake_cnt
  set block_cell_name handshake_cnt_1
  if { [catch {set handshake_cnt_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $handshake_cnt_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: handshake_cnt_2, and set properties
  set block_name handshake_cnt
  set block_cell_name handshake_cnt_2
  if { [catch {set handshake_cnt_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $handshake_cnt_2 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: handshake_cnt_3, and set properties
  set block_name handshake_cnt
  set block_cell_name handshake_cnt_3
  if { [catch {set handshake_cnt_3 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $handshake_cnt_3 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net circ_buff_read_many1_0_fifo_out_0_V_V [get_bd_intf_pins circ_buff_read_many1_0/fifo_out_0_V_V] [get_bd_intf_pins handshake_cnt_0/s_axis]
  connect_bd_intf_net -intf_net circ_buff_read_many1_0_fifo_out_1_V_V [get_bd_intf_pins circ_buff_read_many1_0/fifo_out_1_V_V] [get_bd_intf_pins handshake_cnt_1/s_axis]
  connect_bd_intf_net -intf_net circ_buff_read_many1_0_fifo_out_2_V_V [get_bd_intf_pins circ_buff_read_many1_0/fifo_out_2_V_V] [get_bd_intf_pins handshake_cnt_2/s_axis]
  connect_bd_intf_net -intf_net circ_buff_read_many1_0_fifo_out_3_V_V [get_bd_intf_pins circ_buff_read_many1_0/fifo_out_3_V_V] [get_bd_intf_pins my_design_0/s_axis]
  connect_bd_intf_net -intf_net circ_buff_read_many1_0_m_axi_gmem_read [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins circ_buff_read_many1_0/m_axi_gmem_read]
  connect_bd_intf_net -intf_net circ_buff_write_many_0_m_axi_gmem_out [get_bd_intf_pins axi_smc/S01_AXI] [get_bd_intf_pins circ_buff_write_many_0/m_axi_gmem_out]
  connect_bd_intf_net -intf_net handshake_cnt_0_m_axis [get_bd_intf_pins circ_buff_write_many_0/fifo_in_0_V_V] [get_bd_intf_pins handshake_cnt_0/m_axis]
  connect_bd_intf_net -intf_net handshake_cnt_1_m_axis [get_bd_intf_pins circ_buff_write_many_0/fifo_in_1_V_V] [get_bd_intf_pins handshake_cnt_1/m_axis]
  connect_bd_intf_net -intf_net handshake_cnt_2_m_axis [get_bd_intf_pins circ_buff_write_many_0/fifo_in_2_V_V] [get_bd_intf_pins handshake_cnt_2/m_axis]
  connect_bd_intf_net -intf_net handshake_cnt_3_m_axis [get_bd_intf_pins circ_buff_write_many_0/fifo_in_3_V_V] [get_bd_intf_pins handshake_cnt_3/m_axis]
  connect_bd_intf_net -intf_net my_design_0_m_axis [get_bd_intf_pins handshake_cnt_3/s_axis] [get_bd_intf_pins my_design_0/m_axis]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins circ_buff_read_many1_0/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins circ_buff_write_many_0/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M06_AXI [get_bd_intf_pins axilitectrl_v1_0_0/s00_axi] [get_bd_intf_pins ps8_0_axi_periph/M06_AXI]
  ...
  connect_bd_net -net axilitectrl_v1_0_0_dout0 [get_bd_pins axilitectrl_v1_0_0/dout0] [get_bd_pins handshake_cnt_0/cnt_limit]
  connect_bd_net -net axilitectrl_v1_0_0_dout1 [get_bd_pins axilitectrl_v1_0_0/dout1] [get_bd_pins handshake_cnt_1/cnt_limit]
  connect_bd_net -net axilitectrl_v1_0_0_dout2 [get_bd_pins axilitectrl_v1_0_0/dout2] [get_bd_pins handshake_cnt_2/cnt_limit]
  connect_bd_net -net axilitectrl_v1_0_0_dout3 [get_bd_pins axilitectrl_v1_0_0/dout3] [get_bd_pins handshake_cnt_3/cnt_limit]
  connect_bd_net -net handshake_cnt_0_cycle_cnt [get_bd_pins axilitectrl_v1_0_0/din0] [get_bd_pins handshake_cnt_0/cycle_cnt]
  connect_bd_net -net handshake_cnt_0_data_cnt [get_bd_pins axilitectrl_v1_0_0/din4] [get_bd_pins handshake_cnt_0/data_cnt]
  connect_bd_net -net handshake_cnt_1_cycle_cnt [get_bd_pins axilitectrl_v1_0_0/din1] [get_bd_pins handshake_cnt_1/cycle_cnt]
  connect_bd_net -net handshake_cnt_1_data_cnt [get_bd_pins axilitectrl_v1_0_0/din5] [get_bd_pins handshake_cnt_1/data_cnt]
  connect_bd_net -net handshake_cnt_2_cycle_cnt [get_bd_pins axilitectrl_v1_0_0/din2] [get_bd_pins handshake_cnt_2/cycle_cnt]
  connect_bd_net -net handshake_cnt_2_data_cnt [get_bd_pins axilitectrl_v1_0_0/din6] [get_bd_pins handshake_cnt_2/data_cnt]
  connect_bd_net -net handshake_cnt_3_cycle_cnt [get_bd_pins axilitectrl_v1_0_0/din3] [get_bd_pins handshake_cnt_3/cycle_cnt]
  connect_bd_net -net handshake_cnt_3_data_cnt [get_bd_pins axilitectrl_v1_0_0/din7] [get_bd_pins handshake_cnt_3/data_cnt]
  connect_bd_net -net rst_ps8_0_300M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins axilitectrl_v1_0_0/s00_axi_aresetn] [get_bd_pins circ_buff_read_many1_0/ap_rst_n] [get_bd_pins circ_buff_write_many_0/ap_rst_n] [get_bd_pins mutex_0/S0_AXI_ARESETN] [get_bd_pins mutex_0/S1_AXI_ARESETN] [get_bd_pins mutex_0/S2_AXI_ARESETN] [get_bd_pins mutex_0/S3_AXI_ARESETN] [get_bd_pins my_design_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_300M/peripheral_aresetn]
  connect_bd_net -net rst_ps8_0_300M_peripheral_reset [get_bd_pins handshake_cnt_0/reset] [get_bd_pins handshake_cnt_1/reset] [get_bd_pins handshake_cnt_2/reset] [get_bd_pins handshake_cnt_3/reset] [get_bd_pins rst_ps8_0_300M/peripheral_reset]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_smc/aclk] [get_bd_pins axilitectrl_v1_0_0/s00_axi_aclk] [get_bd_pins circ_buff_read_many1_0/ap_clk] [get_bd_pins circ_buff_write_many_0/ap_clk] [get_bd_pins handshake_cnt_0/clk] [get_bd_pins handshake_cnt_1/clk] [get_bd_pins handshake_cnt_2/clk] [get_bd_pins handshake_cnt_3/clk] [get_bd_pins mutex_0/S0_AXI_ACLK] [get_bd_pins mutex_0/S1_AXI_ACLK] [get_bd_pins mutex_0/S2_AXI_ACLK] [get_bd_pins mutex_0/S3_AXI_ACLK] [get_bd_pins my_design_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_300M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxiacp_fpd_aclk]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces circ_buff_read_many1_0/Data_m_axi_gmem_read] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIACP/ACP_DDR_LOW] SEG_zynq_ultra_ps_e_0_ACP_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces circ_buff_write_many_0/Data_m_axi_gmem_out] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIACP/ACP_DDR_LOW] SEG_zynq_ultra_ps_e_0_ACP_DDR_LOW
  create_bd_addr_seg -range 0x00001000 -offset 0xA0004000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axilitectrl_v1_0_0/s00_axi/reg0] SEG_axilitectrl_v1_0_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs circ_buff_read_many1_0/s_axi_control/Reg] SEG_circ_buff_read_many1_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0020000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs circ_buff_write_many_0/s_axi_control/Reg] SEG_circ_buff_write_many_0_Reg
  ...
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces circ_buff_read_many1_0/Data_m_axi_gmem_read] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIACP/ACP_LPS_OCM] SEG_zynq_ultra_ps_e_0_ACP_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs circ_buff_read_many1_0/Data_m_axi_gmem_read/SEG_zynq_ultra_ps_e_0_ACP_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces circ_buff_write_many_0/Data_m_axi_gmem_out] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIACP/ACP_LPS_OCM] SEG_zynq_ultra_ps_e_0_ACP_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs circ_buff_write_many_0/Data_m_axi_gmem_out/SEG_zynq_ultra_ps_e_0_ACP_LPS_OCM]
...
#  -string -flagsOSRD
preplace inst circ_buff_write_many_0 -pg 1 -lvl 5 -y -340 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -y 110 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 4 -y 320 -defaultsOSRD
preplace inst handshake_cnt_0 -pg 1 -lvl 4 -y -500 -defaultsOSRD
preplace inst handshake_cnt_1 -pg 1 -lvl 4 -y -340 -defaultsOSRD
preplace inst rst_ps8_0_300M -pg 1 -lvl 2 -y -260 -defaultsOSRD
preplace inst handshake_cnt_2 -pg 1 -lvl 4 -y -180 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 7 -y 800 -defaultsOSRD
preplace inst handshake_cnt_3 -pg 1 -lvl 4 -y -20 -defaultsOSRD
preplace inst my_design_0 -pg 1 -lvl 3 -y -270 -defaultsOSRD
preplace inst mutex_0 -pg 1 -lvl 6 -y 320 -defaultsOSRD
preplace inst axilitectrl_v1_0_0 -pg 1 -lvl 1 -y -160 -defaultsOSRD
preplace inst circ_buff_read_many1_0 -pg 1 -lvl 3 -y -450 -defaultsOSRD
preplace netloc my_design_0_m_axis 1 3 1 530
preplace netloc handshake_cnt_3_data_cnt 1 0 5 -1040 -620 N -620 N -620 N -620 910
preplace netloc circ_buff_read_many1_0_fifo_out_2_V_V 1 3 1 540
preplace netloc ps8_0_axi_periph_M05_AXI 1 4 1 1020
preplace netloc ps8_0_axi_periph_M04_AXI 1 2 3 90 600 N 600 920
preplace netloc handshake_cnt_2_cycle_cnt 1 0 5 -1010 -650 N -650 N -650 N -650 940
preplace netloc handshake_cnt_2_m_axis 1 4 1 980
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 7 -1010 0 -360 -380 70 -590 500 -610 1010 -210 1450 580 1690
preplace netloc handshake_cnt_3_cycle_cnt 1 0 5 -1000 -630 N -630 N -630 N -630 920
preplace netloc circ_buff_read_many1_0_fifo_out_0_V_V 1 3 1 540
preplace netloc handshake_cnt_0_m_axis 1 4 1 990
preplace netloc handshake_cnt_1_m_axis 1 4 1 N
preplace netloc handshake_cnt_3_m_axis 1 4 1 990
preplace netloc axi_smc_M00_AXI 1 0 8 -1000 590 NJ 590 NJ 590 NJ 590 NJ 590 NJ 590 NJ 590 2710
preplace netloc ps8_0_axi_periph_M06_AXI 1 0 5 -1070 610 N 610 N 610 N 610 910
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 3 N 80 N 80 490
preplace netloc ps8_0_axi_periph_M02_AXI 1 4 2 1040 250 N
preplace netloc handshake_cnt_2_data_cnt 1 0 5 -1060 -640 N -640 N -640 N -640 930
preplace netloc handshake_cnt_1_data_cnt 1 0 5 -1080 -660 N -660 N -660 N -660 950
preplace netloc handshake_cnt_1_cycle_cnt 1 0 5 -1020 -670 N -670 N -670 N -670 960
preplace netloc handshake_cnt_0_cycle_cnt 1 0 5 -1050 -690 N -690 N -690 N -690 980
preplace netloc axilitectrl_v1_0_0_dout0 1 1 3 -380 -580 N -580 550
preplace netloc ps8_0_axi_periph_M03_AXI 1 4 2 1050 270 N
preplace netloc axilitectrl_v1_0_0_dout1 1 1 3 -370 -370 60 -190 480
preplace netloc ps8_0_axi_periph_M01_AXI 1 4 2 1030 230 N
preplace netloc rst_ps8_0_300M_peripheral_reset 1 2 2 30 -180 560
preplace netloc handshake_cnt_0_data_cnt 1 0 5 -1090 -680 N -680 N -680 N -680 970
preplace netloc axilitectrl_v1_0_0_dout2 1 1 3 -350 -360 40 -150 N
preplace netloc axilitectrl_v1_0_0_dout3 1 1 3 -380 -160 N -160 480
preplace netloc circ_buff_read_many1_0_fifo_out_3_V_V 1 2 2 80 -560 480
preplace netloc ps8_0_axi_periph_M00_AXI 1 4 2 960 210 N
preplace netloc circ_buff_read_many1_0_m_axi_gmem_read 1 3 4 510J -590 NJ -590 N -590 1720
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 1 1 -340
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 1 3 N 100 N 100 480
preplace netloc circ_buff_read_many1_0_fifo_out_1_V_V 1 3 1 550
preplace netloc circ_buff_write_many_0_m_axi_gmem_out 1 5 2 N -350 1710
preplace netloc rst_ps8_0_300M_peripheral_aresetn 1 0 7 -1030 -390 N -390 50 -570 520 -600 1000 -220 1460 570 1700
levelinfo -pg 1 -1110 -690 -150 290 750 1260 1580 2570 2730 -top -850 -bot 960
"
}
