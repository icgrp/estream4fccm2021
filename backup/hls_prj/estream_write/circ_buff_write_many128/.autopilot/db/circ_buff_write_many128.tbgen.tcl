set moduleName circ_buff_write_many128
...
set C_modelName {circ_buff_write_many128}
...
set C_modelArgList {
	...
	{ fifo_in_0_V int 64 regular {axi_s 0 volatile  { fifo_in_0_V Data } }  }
	{ fifo_in_1_V int 64 regular {axi_s 0 volatile  { fifo_in_1_V Data } }  }
	{ fifo_in_2_V int 64 regular {axi_s 0 volatile  { fifo_in_2_V Data } }  }
	{ fifo_in_3_V int 64 regular {axi_s 0 volatile  { fifo_in_3_V Data } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem_out", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":127,"cElement": [{"cName": "output.V","cData": "uint128","bit_use": { "low": 0,"up": 127},"offset": { "type": "dynamic","port_name": "output_V","bundle": "control"},"direction": "READWRITE","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "fifo_in_0_V", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "fifo.V","cData": "long unsigned int","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 0,"step" : 2}]}]}]} , 
 	{ "Name" : "fifo_in_1_V", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "fifo.V","cData": "long unsigned int","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 1,"up" : 1,"step" : 2}]}]}]} , 
 	{ "Name" : "fifo_in_2_V", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "fifo.V","cData": "long unsigned int","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 2,"up" : 2,"step" : 2}]}]}]} , 
 	{ "Name" : "fifo_in_3_V", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "fifo.V","cData": "long unsigned int","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 3,"up" : 3,"step" : 2}]}]}]} ]}
...
set portList { 
	...
	{ fifo_in_0_V_TDATA sc_in sc_lv 64 signal 5 } 
	{ fifo_in_0_V_TVALID sc_in sc_logic 1 invld 5 } 
	{ fifo_in_0_V_TREADY sc_out sc_logic 1 inacc 5 } 
	{ fifo_in_1_V_TDATA sc_in sc_lv 64 signal 6 } 
	{ fifo_in_1_V_TVALID sc_in sc_logic 1 invld 6 } 
	{ fifo_in_1_V_TREADY sc_out sc_logic 1 inacc 6 } 
	{ fifo_in_2_V_TDATA sc_in sc_lv 64 signal 7 } 
	{ fifo_in_2_V_TVALID sc_in sc_logic 1 invld 7 } 
	{ fifo_in_2_V_TREADY sc_out sc_logic 1 inacc 7 } 
	{ fifo_in_3_V_TDATA sc_in sc_lv 64 signal 8 } 
	{ fifo_in_3_V_TVALID sc_in sc_logic 1 invld 8 } 
	{ fifo_in_3_V_TREADY sc_out sc_logic 1 inacc 8 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"circ_buff_write_many128","role":"start","value":"0","valid_bit":"0"},{"name":"circ_buff_write_many128","role":"continue","value":"0","valid_bit":"4"},{"name":"circ_buff_write_many128","role":"auto_start","value":"0","valid_bit":"7"},{"name":"output_V","role":"data","value":"16"},{"name":"reset","role":"data","value":"24"},{"name":"debug_register","role":"data","value":"32"},{"name":"useable_words","role":"data","value":"48"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"circ_buff_write_many128","role":"start","value":"0","valid_bit":"0"},{"name":"circ_buff_write_many128","role":"done","value":"0","valid_bit":"1"},{"name":"circ_buff_write_many128","role":"idle","value":"0","valid_bit":"2"},{"name":"circ_buff_write_many128","role":"ready","value":"0","valid_bit":"3"},{"name":"circ_buff_write_many128","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "control", "role": "interrupt" } }, 
 	...
 	{ "name": "fifo_in_0_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "fifo_in_0_V", "role": "TDATA" }} , 
 	{ "name": "fifo_in_0_V_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "fifo_in_0_V", "role": "TVALID" }} , 
 	{ "name": "fifo_in_0_V_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "fifo_in_0_V", "role": "TREADY" }} , 
 	{ "name": "fifo_in_1_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "fifo_in_1_V", "role": "TDATA" }} , 
 	{ "name": "fifo_in_1_V_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "fifo_in_1_V", "role": "TVALID" }} , 
 	{ "name": "fifo_in_1_V_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "fifo_in_1_V", "role": "TREADY" }} , 
 	{ "name": "fifo_in_2_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "fifo_in_2_V", "role": "TDATA" }} , 
 	{ "name": "fifo_in_2_V_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "fifo_in_2_V", "role": "TVALID" }} , 
 	{ "name": "fifo_in_2_V_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "fifo_in_2_V", "role": "TREADY" }} , 
 	{ "name": "fifo_in_3_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "fifo_in_3_V", "role": "TDATA" }} , 
 	{ "name": "fifo_in_3_V_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "fifo_in_3_V", "role": "TVALID" }} , 
 	{ "name": "fifo_in_3_V_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "fifo_in_3_V", "role": "TREADY" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		"CDFG" : "circ_buff_write_many128",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "fifo_in_0_V", "Type" : "Axis", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "fifo_in_0_V_TDATA_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "fifo_in_1_V", "Type" : "Axis", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "fifo_in_1_V_TDATA_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "fifo_in_2_V", "Type" : "Axis", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "fifo_in_2_V_TDATA_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "fifo_in_3_V", "Type" : "Axis", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "fifo_in_3_V_TDATA_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "first", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "head_3", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "head_0", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "head_1", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "head_2", "Type" : "OVld", "Direction" : "IO"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.circ_buff_write_many128_control_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.circ_buff_write_many128_gmem_out_m_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.data_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.circ_buff_write_many128_mux_42_8_1_1_U1", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.circ_buff_write_many128_mux_42_8_1_1_U2", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	circ_buff_write_many128 {
		gmem_out {Type IO LastRead 17 FirstWrite 15}
		...
		fifo_in_0_V {Type I LastRead 13 FirstWrite -1}
		fifo_in_1_V {Type I LastRead 13 FirstWrite -1}
		fifo_in_2_V {Type I LastRead 13 FirstWrite -1}
		fifo_in_3_V {Type I LastRead 13 FirstWrite -1}
		first {Type IO LastRead -1 FirstWrite -1}
		head_3 {Type IO LastRead -1 FirstWrite -1}
		head_0 {Type IO LastRead -1 FirstWrite -1}
		head_1 {Type IO LastRead -1 FirstWrite -1}
		head_2 {Type IO LastRead -1 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	fifo_in_0_V { axis {  { fifo_in_0_V_TDATA in_data 0 64 }  { fifo_in_0_V_TVALID in_vld 0 1 }  { fifo_in_0_V_TREADY in_acc 1 1 } } }
	fifo_in_1_V { axis {  { fifo_in_1_V_TDATA in_data 0 64 }  { fifo_in_1_V_TVALID in_vld 0 1 }  { fifo_in_1_V_TREADY in_acc 1 1 } } }
	fifo_in_2_V { axis {  { fifo_in_2_V_TDATA in_data 0 64 }  { fifo_in_2_V_TVALID in_vld 0 1 }  { fifo_in_2_V_TREADY in_acc 1 1 } } }
	fifo_in_3_V { axis {  { fifo_in_3_V_TDATA in_data 0 64 }  { fifo_in_3_V_TVALID in_vld 0 1 }  { fifo_in_3_V_TREADY in_acc 1 1 } } }
}
