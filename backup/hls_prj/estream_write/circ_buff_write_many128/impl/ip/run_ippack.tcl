...
set Library     "hls"
set IPName      "circ_buff_write_many128"
set Version     "1.0"
set DisplayName "Circ_buff_write_many128"
set Revision    "2104021721"
set Description "An IP generated by Vivado HLS"
set Device      "zynquplus"
set AutoFamily  ""
set Taxonomy    "/VIVADO_HLS_IP"
set has_xpm_memory "0"
set sdx_kernel_name "circ_buff_write_many128"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set xo_hls_files_dir ""
set hdl_module_list {circ_buff_write_many128_mux_42_8_1_1
...
## Variables
set Top "circ_buff_write_many128"
set TopNoPrefix "circ_buff_write_many128"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 output_V W 0x0 "Data signal of output_V" {{0 32 output_V W 0 "Bit 31 to 0 Data signal of output_V"}}} {0x18 reset W 0x0 "Data signal of reset" {{0 8 reset W 0 "Bit 7 to 0 Data signal of reset"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 debug_register_1 W 0x0 "Data signal of debug_register" {{0 32 debug_register W 0 "Bit 31 to 0 Data signal of debug_register"}}} {0x24 debug_register_2 W 0x0 "Data signal of debug_register" {{0 32 debug_register W 0 "Bit 63 to 32 Data signal of debug_register"}}}}
