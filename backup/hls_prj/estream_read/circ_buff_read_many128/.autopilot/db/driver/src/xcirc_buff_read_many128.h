...
// ==============================================================
#ifndef XCIRC_BUFF_READ_MANY128_H
#define XCIRC_BUFF_READ_MANY128_H
...
#include <stddef.h>
#endif
#include "xcirc_buff_read_many128_hw.h"
...
} XCirc_buff_read_many128_Config;
#endif

typedef struct {
    u32 Control_BaseAddress;
    u32 IsReady;
} XCirc_buff_read_many128;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XCirc_buff_read_many128_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XCirc_buff_read_many128_ReadReg(BaseAddress, RegOffset) \
