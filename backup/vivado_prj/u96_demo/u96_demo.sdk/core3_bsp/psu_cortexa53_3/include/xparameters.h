...
#define XPAR_PSU_CORTEXA53_3_CPU_CLK_FREQ_HZ 1200000000
#define XPAR_PSU_CORTEXA53_3_TIMESTAMP_CLK_FREQ 100000000
...
/* Definitions for driver CIRC_BUFF_READ_128 */
#define XPAR_XCIRC_BUFF_READ_128_NUM_INSTANCES 1

/* Definitions for peripheral CIRC_BUFF_READ_128_0 */
#define XPAR_CIRC_BUFF_READ_128_0_DEVICE_ID 0
#define XPAR_CIRC_BUFF_READ_128_0_S_AXI_CONTROL_BASEADDR 0xA0010000
#define XPAR_CIRC_BUFF_READ_128_0_S_AXI_CONTROL_HIGHADDR 0xA001FFFF


/******************************************************************/

/* Canonical definitions for peripheral CIRC_BUFF_READ_128_0 */
#define XPAR_XCIRC_BUFF_READ_128_0_DEVICE_ID XPAR_CIRC_BUFF_READ_128_0_DEVICE_ID
#define XPAR_XCIRC_BUFF_READ_128_0_S_AXI_CONTROL_BASEADDR 0xA0010000
#define XPAR_XCIRC_BUFF_READ_128_0_S_AXI_CONTROL_HIGHADDR 0xA001FFFF


/******************************************************************/

/* Definitions for driver CIRC_BUFF_WRITE_128 */
#define XPAR_XCIRC_BUFF_WRITE_128_NUM_INSTANCES 1

/* Definitions for peripheral CIRC_BUFF_WRITE_128_0 */
#define XPAR_CIRC_BUFF_WRITE_128_0_DEVICE_ID 0
#define XPAR_CIRC_BUFF_WRITE_128_0_S_AXI_CONTROL_BASEADDR 0xA0050000
#define XPAR_CIRC_BUFF_WRITE_128_0_S_AXI_CONTROL_HIGHADDR 0xA005FFFF


/******************************************************************/

/* Canonical definitions for peripheral CIRC_BUFF_WRITE_128_0 */
#define XPAR_XCIRC_BUFF_WRITE_128_0_DEVICE_ID XPAR_CIRC_BUFF_WRITE_128_0_DEVICE_ID
#define XPAR_XCIRC_BUFF_WRITE_128_0_S_AXI_CONTROL_BASEADDR 0xA0050000
#define XPAR_XCIRC_BUFF_WRITE_128_0_S_AXI_CONTROL_HIGHADDR 0xA005FFFF
...
#define XPAR_MUTEX_0_IF_0_BASEADDR 0xA0000000U
#define XPAR_MUTEX_0_IF_0_NUM_MUTEX 16U
#define XPAR_MUTEX_0_IF_0_ENABLE_USER 0U

/* Definitions for peripheral MUTEX_0 IF 1 */
#define XPAR_MUTEX_0_IF_1_DEVICE_ID 1U
#define XPAR_MUTEX_0_IF_1_BASEADDR 0xA0001000U
#define XPAR_MUTEX_0_IF_1_NUM_MUTEX 16U
#define XPAR_MUTEX_0_IF_1_ENABLE_USER 0U

/* Definitions for peripheral MUTEX_0 IF 2 */
#define XPAR_MUTEX_0_IF_2_DEVICE_ID 2U
#define XPAR_MUTEX_0_IF_2_BASEADDR 0xA0002000U
#define XPAR_MUTEX_0_IF_2_NUM_MUTEX 16U
#define XPAR_MUTEX_0_IF_2_ENABLE_USER 0U

/* Definitions for peripheral MUTEX_0 IF 3 */
#define XPAR_MUTEX_0_IF_3_DEVICE_ID 3U
#define XPAR_MUTEX_0_IF_3_BASEADDR 0xA0003000U
#define XPAR_MUTEX_0_IF_3_NUM_MUTEX 16U
#define XPAR_MUTEX_0_IF_3_ENABLE_USER 0U

/* Definitions for driver MUTEX */
#define XPAR_XMUTEX_NUM_INSTANCES 4U
