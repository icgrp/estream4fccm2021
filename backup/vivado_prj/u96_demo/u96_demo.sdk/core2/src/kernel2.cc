...
//	pr_flow::stream Core2_hw_rx1( pr_flow::stream_id_t::STREAM_ID_0, pr_flow::direction_t::RX,pr_flow::width_t::U32_BITS, pr_flow::axi_port_t::HP0,mem );
//	pr_flow::stream Core2_hw_tx2( pr_flow::stream_id_t::STREAM_ID_1, pr_flow::direction_t::TX,pr_flow::width_t::U32_BITS, pr_flow::axi_port_t::HP0,mem );
//	Core2_hw_rx1.start_stream();
//	Core2_hw_tx2.start_stream();
