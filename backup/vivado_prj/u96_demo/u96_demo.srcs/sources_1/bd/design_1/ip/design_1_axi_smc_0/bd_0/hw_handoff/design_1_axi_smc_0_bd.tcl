...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.RDATA_WIDTH {128} \
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
   CONFIG.SSC000_ROUTE {0b00000001} \
   CONFIG.SSC001_ROUTE {0b00000000} \
   CONFIG.SSC002_ROUTE {0b00000000} \
   CONFIG.SSC003_ROUTE {0b00010000} \
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_SC_AR_2 [get_bd_intf_pins s04_axi2sc/M_SC_AR] [get_bd_intf_pins s04_nodes/S_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_AW_2 [get_bd_intf_pins s04_axi2sc/M_SC_AW] [get_bd_intf_pins s04_nodes/S_SC_AW]
  ...
  connect_bd_intf_net -intf_net S_SC_B_2 [get_bd_intf_pins s04_nodes/S_SC_B] [get_bd_intf_pins switchboards/M04_SC_B]
  ...
  connect_bd_intf_net -intf_net S_SC_R_2 [get_bd_intf_pins s04_nodes/S_SC_R] [get_bd_intf_pins switchboards/M04_SC_R]
  ...
  connect_bd_intf_net -intf_net S_SC_W_2 [get_bd_intf_pins s04_axi2sc/M_SC_W] [get_bd_intf_pins s04_nodes/S_SC_W]
  ...
  connect_bd_net -net aclk_2 [get_bd_pins clk_map/S04_ACLK] [get_bd_pins s04_axi2sc/aclk] [get_bd_pins s04_entry_pipeline/aclk] [get_bd_pins s04_nodes/s_sc_clk]
  ...
  connect_bd_net -net aresetn_3 [get_bd_pins clk_map/S04_ARESETN] [get_bd_pins s04_entry_pipeline/aresetn] [get_bd_pins s04_nodes/s_sc_resetn]
  ...
  connect_bd_net -net swbd_aclk_net [get_bd_pins clk_map/swbd_aclk] [get_bd_pins m00_nodes/s_axi_aclk] [get_bd_pins s00_nodes/m_sc_clk] [get_bd_pins s04_nodes/m_sc_clk] [get_bd_pins switchboards/aclk]
  connect_bd_net -net swbd_aresetn_net [get_bd_pins clk_map/swbd_aresetn] [get_bd_pins m00_nodes/s_axi_aresetn] [get_bd_pins s00_nodes/m_sc_resetn] [get_bd_pins s04_nodes/m_sc_resetn] [get_bd_pins switchboards/aresetn]
