...
![Demo design Overview](./images/estream.gif)  *(These images aren't coming up inline in the anonymizer; click on the link text to see the image.)*
...
![Vivado Block Diagram for Design](./images/my_design.png)
...
![Verilog Design](./images/add10.png)
...
![Rerun with modified FPGA design](./images/add100.png)
